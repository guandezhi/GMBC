...
import com.gdz.gen.entity.TableEntity;
...
public class GenUtils {
	...
	public static List<String> getTemplates() {
		...
		templates.add("template/DaoSqlProvider.java.vm");
	 ...
	 * 生成代码
	 */
	public static void generatorCode(TablesEntity table, List<ColumnEntity> columns, ZipOutputStream zip) {
		// 配置信息
		...
		mainPath = StringUtils.isBlank(mainPath) ? "com.gdz.code" : mainPath;
		// 封装模板数据
	...
	public static String getFileName(String template, String className, String packageName, String moduleName) {
		...
		if (template.contains("DaoSqlProvider.java.vm")) {
			return packagePath + "dao" + File.separator + "provider" + File.separator + className + "SqlProvider.java";
		}
		...
		if (template.contains("list.html.vm")) {
			return "main" + File.separator + "resources" + File.separator + "views" + File.separator + "modules"
